...
def create_app(db_url=None):
    ...
    # Initializes Flask-SQLAlchemy and passes app object to connect with
    db.init_app(app)

    # Must be after init_app
    migrate = Migrate(app, db)

    # Connects flask_smorest to the flask app
    api = Api(app)

    # Use import secrets and secrets.SystemRandom().getrandbits(128)
    ...
    # WAY 1 (not needed if we use Flask-Migrate to create database tables)
    # with app.app_context():
    #     db.create_all() # This will create tables IF NOT EXIST
    # WAY 2 (no longer necessary)
